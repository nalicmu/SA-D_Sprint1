...
//    }
    ...
    public static Result profile(Long id) {
        ...
        ProfileInterface profile1 = profileFactory.getProfile("friend");
        List<User> myfriends = profile1.getFriends(Long.parseLong(session("id")));

        ProfileInterface profile2 = profileFactory.getProfile("follow");
        List<User> followers = profile2.getFollow(id, ProfileInterface.FollowType.FOLLOWER);
        List<User> followees = profile2.getFollow(id, ProfileInterface.FollowType.FOLLOWEE);
